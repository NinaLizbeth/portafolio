  ...
  return (
    ...
    <div className='flex flex-row w-full min-h-screen'>
      <div className='h-screen bg-green-300 flex justify-center items-center w-full lg:w-3/5  flex-col p-10 md:pr-52 '>
        ...
        <p className=' text-center lg:text-left  text-5xl lg:text-7xl font-bold '>Y creo experiencias web únicas que fusionan <motion.span  
        style={fontRampart.style} className='text-pink-300 text-6xl font-bold hover:scale-150'>creatividad</motion.span> y <span style={fontRampart.style}className='text-white text-6xl font-bold'>
