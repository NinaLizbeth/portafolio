...
whileInView="entrada"
variants={variantes}
className="w-96 h-96 border-4 rounded-xl shadow-2xl mt-28">
  ...
  className="w-96 h-96 border-4 rounded-xl shadow-2xl mt-28"><div className="flex flex-row p-2 gap-2">
      <div className="rounded-full w-5 h-5 bg-pink-300"></div>
      <div  className="rounded-full w-5 h-5 bg-yellow-200"></div>
      <div  className="rounded-full w-5 h-5 bg-green-300"></div>
    </div>
    <hr  className="mb-10 border-t-2 border-withe- border-2 w-full mx-auto" /><p style={FontKalam.style} className="p-5 text-white text-2xl text-center">Comencé como una apasionada estudiante de programación y mi amor por desafíos me llevó a nuevos horizontes. Hoy, construyo mundos digitales a medida.</p></motion.div>
  <motion.div
  transition={{duration:1}}
  initial="inicial"
  whileInView="entrada"
