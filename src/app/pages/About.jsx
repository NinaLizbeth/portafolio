    ...
    <>
      <section id="aboutId">
        <h2
          ...
          className=" absolute ml-12 lg:ml-[30%] text-white text-4xl text-center lg:text-7xl mt-8 "
        >
          Un poquito de <br /> mi...
        </h2>

        <article className=" w-full lg:h-max h-max bg-violet-400 flex  flex-col lg:flex-row lg:gap-20 gap-0 md:p-24 lg:justify-around justify-center items-center py-20 ">
          <motion.div
            transition={{ duration: 1 }}
            initial="inicial"
            whileInView="entrada"
            variants={variantes}
            className=" w-80 lg:w-96 border-4 rounded-xl shadow-2xl mt-20 lg:mt-44"
          >
            ...
            <hr className="border-t-2 border-withe- border-2 w-full mx-auto" />

            <p style={FontKalam.style} className="p-5 lg:p-5 text-center  text-white text-2xl ">
              A los 39 años, mi viaje en la programación se convirtió en una pasión. Amo los
              desafíos y aprender cada día. mi familia y mi curiosidad me impulsan a soñar en grande
          ...
          >
            ...
            <hr className=" border-t-2 border-withe- border-2 w-full mx-auto" />
            <p style={FontKalam.style} className="p-5 lg:p-5 text-center  text-white text-2xl ">
              Comencé como una apasionada estudiante de programación y mi amor por desafíos me llevó
              a nuevos horizontes. Hoy, construyo mundos digitales a medida.
            </p>
          </motion.div>
          <motion.div
            transition={{ duration: 1 }}
          ...
          >
            ...
            <hr className="border-t-2 border-withe- border-2 w-full mx-auto" />
            <p style={FontKalam.style} className="p-5 lg:p-5 text-center  text-white text-2xl ">
              Además de la programación, soy una apasionada de los libros por lo cual uno de mis
              grandes sueños es fusionar el código y fantasía para llevar a los lectores a nuevos
              mundos{' '}
            </p>
          </motion.div>
        </article>
