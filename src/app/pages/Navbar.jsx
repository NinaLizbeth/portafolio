    ...
    <>
      <nav className="absolute top-4 lefth-14 p-4 cursor-pointer">
        <ul className="flex flex-row gap-6 ml-auto">
          ...
          <a href="#contactoId"><li className="text-white p-2 rounded-lg  bg-pink-300 shadow-xl  hover:scale-125">Contacto</li></a>
          
        </ul>

      
      </nav>
      <Link href="/"><h2 style={fontSatisfy.style}  className="absolute right-36 mt-5 text-6xl text-pink-400">Nina </h2></Link>
    </>
  )
}
