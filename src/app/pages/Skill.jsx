        ...
        >
          <div className="flex flex-col lg:flex-row lg:justify-around justify-center ">
            <div>
              ...
              <h4 style={fontRampart.style} className="lg:text-5xl text-4xl text-white lg:mr-36 text-center mt-20">Tools</h4>
              <ul className="lg:p-0 p-14 lg:mr-0 lg:mt-6 lg:w-[70%]">
            ...
            <div>
              ...
              <ul className="lg:p-0 p-14 lg:mr-36 lg:mt-6">
                ...
                <li style={fontRampart.style} className="bg-yellow-200 text-black rounded-3xl text-center text-3xl mb-4 shadow-xl" >Python/Django</li>
                <li style={fontRampart.style} className="bg-yellow-200 text-black rounded-3xl text-center text-3xl mb-4 shadow-xl" >SQL /PostgreSQL</li>


                <h4 style={fontRampart.style} className="lg:text-5xl text-4xl text-white lg:mr-30 text-center mt-20">Cloud/PAAS</h4>
